...
****--------------------------TRACER------------------------------------------------------------------------------
    WriteData = "GB.JBL.I.ATM.ACC.CHK = Y.GET.MESSAGE: ":Y.GET.MESSAGE:" Y.VFUNCTION: ":Y.VFUNCTION:" Y.FUNC: ":Y.FUNC:" Y.GET.OFS.MESSAGE: ":Y.GET.OFS.MESSAGE:" Y.OFS.OPERATION: ":Y.OFS.OPERATION:" Y.COMP.OFSOPS: ":Y.COMP.OFSOPS:" Y.CARD.REC.STATUS: ":Y.CARD.REC.STATUS
