    ...
    IF Y.LC.IMP.EXP EQ 'E' THEN
        ...
        IF R.CCY.REC THEN
            LOCATE Y.CCY.MKT IN Y.CCY.MARKET<1,1> SETTING Y.CCY.POS THEN
                Y.EXCHANGE.RATE = Y.MID.REVAL.RATE<1,Y.CCY.POS>
            END
        END
