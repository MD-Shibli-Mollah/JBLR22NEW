...
* <Rating>-7</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE BD.H.FT.REM.PURPOSE.FIELDS
*-----------------------------------------------------------------------------
*<doc>
* Template for field definitions routine BD.H.FT.REM.PURPOSE.FIELDS
*
...
*    CALL Table.defineId("REM.PURPOSE.ID", T24_String) ;* Define Table id
    ID.F = "REM.PURPOSE.ID" ; ID.N = "3" ; ID.T = "A"
*-----------------------------------------------------------------------------
    CALL Table.addFieldDefinition("DESCRIPTION", "35.1", "A", "")
    CALL Table.addFieldDefinition("REMITT.TYPE", "10.1", "":FM:"PRIVATE_COMMERCIAL", "")
    CALL Table.addFieldDefinition("APP.ALLOWED", "14.1", "":FM:"FUNDS.TRANSFER_TELLER_BOTH", "")
