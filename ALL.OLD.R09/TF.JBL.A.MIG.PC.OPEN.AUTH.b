SUBROUTINE TF.JBL.A.MIG.PC.OPEN.AUTH
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
* Modification History : this routine update job register pc related field with Pc Arrangement data.
* 07/11/2020 -                            Retrofit   - MAHMUDUR RAHMAN UDOY,
*                                                 FDS Bangladesh Limited
*Attach Activity.Api: JBL.TF.PC.OPEN.API
*-----------------------------------------------------------------------------
*
    $INSERT I_EQUATE
    $INSERT I_COMMON
...
*SET PC PRODUCT ARR FILED DATA TO JOB.REGISTER APPLICATON.....................................
    R.BTB.JOB.REGISTER<BTB.JOB.PCECC.LOAN.ID,Y.COUNT> = AA.Framework.getC_aalocarrid()
    R.BTB.JOB.REGISTER<BTB.JOB.LOAN.FC.CUR,Y.COUNT> = Y.JOB.ENCUR
    R.BTB.JOB.REGISTER<BTB.JOB.LOAN.AMT.FCY,Y.COUNT> = Y.DOC.VL
    R.BTB.JOB.REGISTER<BTB.JOB.LOAN.EX.RT,Y.COUNT> = Y.EXCH.RATE
    R.BTB.JOB.REGISTER<BTB.JOB.LOAN.AMT.LCY,Y.COUNT> = Y.AMT
