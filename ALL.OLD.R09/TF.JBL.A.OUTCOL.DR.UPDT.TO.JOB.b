...
SUBROUTINE TF.JBL.A.OUTCOL.DR.UPDT.TO.JOB
*-----------------------------------------------------------------------------
* Attacted Version: DRAWINGS,BD.OUTCOLL
* Description: Need to update Job register crosponding EX LC agunest Sales Contact dr id field
*              & Total Drawing Amount..
*-----------------------------------------------------------------------------
* Modification History :  12/19/2020                Create by: Mahmudur Rahman udoy
* Description:
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
******************************Modified 12/19/2020********************
                    Y.LAST.TOT.DR.AMT = R.JOB.REG<BTB.JOB.TOT.EX.LC.DRAW.AMT>
                    Y.TOT.DR.AMT = Y.LAST.TOT.DR.AMT + Y.DR.AMT
                    R.JOB.REG<BTB.JOB.TOT.EX.LC.DRAW.AMT> = Y.TOT.DR.AMT
****************************Modified 12/19/2020 End******************
