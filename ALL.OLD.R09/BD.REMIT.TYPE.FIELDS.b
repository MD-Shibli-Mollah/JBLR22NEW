...
* <Rating>-7</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE BD.REMIT.TYPE.FIELDS
*-----------------------------------------------------------------------------
*<doc>
* Template for field definitions routine BD.REMIT.TYPE.FIELDS
*
...
*** </region>
*-----------------------------------------------------------------------------
    CALL Table.defineId("REMIT.TYPE.ID", T24_String) ;* Define Table id
    ID.N = "3"
*-----------------------------------------------------------------------------
