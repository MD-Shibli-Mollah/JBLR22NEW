SUBROUTINE JBL.ENQ.LC.EXPORT.PAY.DETAILS(Y.RETURN)
*-----------------------------------------------------------------------------
...
*---------
    ...
    IF Y.CUS.NO EQ '' AND Y.FROM.DATE NE '' AND Y.TO.DATE NE '' AND Y.LC.DR.TYPE NE '' AND Y.LC.DR.CCY NE '' THEN
        ! LIVE
        L.STMT ='SELECT ':FN.DR :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND LT.TF.DT.PAYMNT GE ':Y.FROM.DATE:' AND LT.TF.DT.PAYMNT LE ':Y.TO.DATE:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
        EB.DataAccess.Readlist(L.STMT,L.REC,'',L.SIZE,L.ERR)

        !HISTORY
        H.STMT ='SELECT ':FN.DR.HIS :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND LT.TF.DT.PAYMNT GE ':Y.FROM.DATE:' AND LT.TF.DT.PAYMNT LE ':Y.TO.DATE:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
    ...
    END ELSE
        IF Y.CUS.NO NE '' AND Y.FROM.DATE EQ '' AND Y.TO.DATE EQ '' AND Y.LC.DR.TYPE NE '' AND Y.LC.DR.CCY NE '' THEN
            ! LIVE
            L.STMT ='SELECT ':FN.DR :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND  LT.TF.APL.CUSNO EQ ':Y.CUS.NO:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
            EB.DataAccess.Readlist(L.STMT,L.REC,'',L.SIZE,L.ERR)
      
            !HISTORY
            H.STMT ='SELECT ':FN.DR.HIS :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND  LT.TF.APL.CUSNO EQ ':Y.CUS.NO:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
            EB.DataAccess.Readlist(H.STMT,H.REC,'',H.SIZE,H.ERR)
        END
        IF Y.CUS.NO NE '' AND Y.FROM.DATE NE '' AND Y.TO.DATE NE '' AND Y.LC.DR.TYPE NE '' AND Y.LC.DR.CCY NE '' THEN
            ! LIVE
            L.STMT ='SELECT ':FN.DR :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND LT.TF.DT.PAYMNT GE ':Y.FROM.DATE:' AND LT.TF.DT.PAYMNT LE ':Y.TO.DATE:' AND  LT.TF.APL.CUSNO EQ ':Y.CUS.NO: ' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
            EB.DataAccess.Readlist(L.STMT,L.REC,'',L.SIZE,L.ERR)
          
            !HISTORY
            H.STMT ='SELECT ':FN.DR.HIS :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' AND LT.TF.DT.PAYMNT GE ':Y.FROM.DATE:' AND LT.TF.DT.PAYMNT LE ':Y.TO.DATE:' AND  LT.TF.APL.CUSNO EQ ':Y.CUS.NO: ' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
            EB.DataAccess.Readlist(H.STMT,H.REC,'',H.SIZE,H.ERR)
        END
        IF Y.CUS.NO EQ '' AND Y.FROM.DATE EQ '' AND Y.TO.DATE EQ '' AND Y.LC.DR.TYPE NE '' AND Y.LC.DR.CCY NE '' THEN
            ! LIVE
            L.STMT ='SELECT ':FN.DR :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
            EB.DataAccess.Readlist(L.STMT,L.REC,'',L.SIZE,L.ERR)
            
            !HISTORY
            H.STMT ='SELECT ':FN.DR.HIS :' WITH LC.CREDIT.TYPE EQ ':Y.LC.DR.TYPE:' AND DRAW.CURRENCY EQ ':Y.LC.DR.CCY:' AND (DRAWING.TYPE EQ ':"MA":' OR  DRAWING.TYPE EQ ':"SP":') AND CO.CODE EQ ':Y.COMPANY:' BY LC.CREDIT.TYPE BY DRAW.CURRENCY'
            EB.DataAccess.Readlist(H.STMT,H.REC,'',H.SIZE,H.ERR)
        END
    END
...
*----------------------
    ...
    END
    GOSUB GET.LC.CATE.DES
    Y.RETURN.DATA<-1>=Y.CATE.DES:"*":Y.LC.DR.TYPE:"*":Y.LC.DR.CURR:"*":Y.LC.DR.AMT:"*":Y.RELZ.AMT:'*':Y.CM.POR:'*':Y.FROM.DATE:"*":Y.TO.DATE:"*":Y.CUS.NO:"*":Y.CUS.NAME
RETURN
END
