SUBROUTINE TF.JBL.A.PC.COM.AMT.AMD
*-----------------------------------------------------------------------------
* Attach to Activity.Api: JBL.TF.PC.OPEN.API
*-----------------------------------------------------------------------------
* Description : this routine update job register Packing credit related field with PC ARR data.
