SUBROUTINE TF.JBL.A.ELC.REP.JOB.UPDT.AMD
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
* Modification History :12/10/2020
* Description: this Routine is created by coping the full routine TF.JBL.A.BTB.ELC.REP.AMD expect the modification
* Modification Description: The previous routine(TF.JBL.A.BTB.ELC.REP.AMD) only update job register BTB Entitle Amt & PC Entitle Amt but
*                           bank demand Export Lc Replacement Amendment Update the job register lelated field.
* Modifided Line :
* Line 51: POS(8 to 11) Added 4 local filed.
* Line 175 - 180
* Line 186 - 195
* Line 201 - 211
* Line 230 - 246
...
**********
    ...
    LOCAL.FIELDS = 'LT.TF.JOB.NUMBR':VM:'LT.TF.SCONT.ID':VM:'LT.TF.CONT.RAMT':VM:'LT.TF.FULL.REP':VM:'LT.TF.JOB.EX.RT':VM:'LT.TF.BTB.ENTAM':VM:'LT.TF.PC.ENT.AM':VM:'LT.TF.EXCES.AMT':VM:'LT.TF.NET.FOBVL':VM:'LT.TF.BTB.ENTRT':VM:'LT.TF.PC.ENT.RT'
...
* update Replace ELC Ref No, Replacement Date and Covered Amt to Sales Contract
    ...
    END
*******************ADDED BY EBRAHIM************21 DEC 2020************
    R.SCT.REC<SCT.TOT.ELC.COVERED.AMT> += Y.TF.CONT.RAMT - Y.TF.CONT.RAMT.ROLD
    R.SCT.REC<SCT.EXCESS.REPLACE.AMT> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcLocalRef)<1, Y.EXCESS.REP.AMT.POS>
*******************************END**********************************
...
********************
    ...
    IF R.JOB.REC THEN
        ...
        Y.TF.BTB.AMT = Y.LC.LOC.REF<1,Y.TF.BTB.EAMT.POS>
        Y.TF.BTB.EAMT= ( Y.TF.BTB.AMT * Y.TF.EXCHG.RTE)
        Y.TF.PC.AMT  = Y.LC.LOC.REF<1,Y.TF.PC.EAMT.POS>
        Y.TF.PC.EAMT = ( Y.TF.PC.AMT * Y.TF.EXCHG.RTE)
...
****************************************Modification - 12/10/2020******************************
        Y.NEW.EX.AMT = Y.LC.LOC.REF<1,Y.EXCESS.REP.AMT.POS>
        Y.NEW.FOB.AMT = Y.LC.LOC.REF<1,Y.NET.FOBVL.POS>
        Y.OLD.EX.AMT = Y.LC.LOC.REF.ROLD.LST<1,Y.EXCESS.REP.AMT.POS>
        Y.OLD.FOB.AMT = Y.LC.LOC.REF.ROLD.LST<1,Y.NET.FOBVL.POS>
****************************************
...
****************************************Modification - 12/10/2020******************************
            R.JOB.REC<BTB.JOB.EX.ISSUE.DATE,Y.ELC.TF.REFNO.POS2> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcIssueDate)
            R.JOB.REC<BTB.JOB.EX.LC.NUMBER,Y.ELC.TF.REFNO.POS2> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcIssBankRef)
*        R.JOB.REC<BTB.JOB.EX.LC.CURRENCY,Y.ELC.TF.REF.CNT> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcLcCurrency)
            R.JOB.REC<BTB.JOB.EX.LC.AMOUNT,Y.ELC.TF.REFNO.POS2> = Y.NEW.EX.AMT
            R.JOB.REC<BTB.JOB.EX.NET.FOB.VALUE,Y.ELC.TF.REFNO.POS2> = Y.NEW.FOB.AMT
            R.JOB.REC<BTB.JOB.EX.EXPIRY.DATE,Y.ELC.TF.REFNO.POS2> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcAdviceExpiryDate)
            R.JOB.REC<BTB.JOB.EX.BTB.ENT.PER,Y.ELC.TF.REFNO.POS2> = Y.LC.LOC.REF<1,Y.BTB.RT.POS>
            R.JOB.REC<BTB.JOB.EX.PC.ENT.PER,Y.ELC.TF.REFNO.POS2> = Y.LC.LOC.REF<1,Y.PC.RT.POS>
***********************************************************************
        END ELSE
...
****************************************Modification - 12/10/2020******************************
            Y.LC.LOC.REF.RNEW.LST = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcLocalRef)
            R.JOB.REC<BTB.JOB.EX.ISSUE.DATE,Y.ELC.TF.REF.CNT> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcIssueDate)
            R.JOB.REC<BTB.JOB.EX.LC.NUMBER,Y.ELC.TF.REF.CNT> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcIssBankRef)
*        R.JOB.REC<BTB.JOB.EX.LC.CURRENCY,Y.ELC.TF.REF.CNT> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcLcCurrency)
            R.JOB.REC<BTB.JOB.EX.LC.AMOUNT,Y.ELC.TF.REF.CNT> = Y.NEW.EX.AMT
            R.JOB.REC<BTB.JOB.EX.NET.FOB.VALUE,Y.ELC.TF.REF.CNT> = Y.NEW.FOB.AMT
            R.JOB.REC<BTB.JOB.EX.EXPIRY.DATE,Y.ELC.TF.REF.CNT> = EB.SystemTables.getRNew(LC.Contract.LetterOfCredit.TfLcAdviceExpiryDate)
            R.JOB.REC<BTB.JOB.EX.BTB.ENT.PER,Y.ELC.TF.REF.CNT> = Y.LC.LOC.REF<1,Y.BTB.RT.POS>
            R.JOB.REC<BTB.JOB.EX.PC.ENT.PER,Y.ELC.TF.REF.CNT> = Y.LC.LOC.REF<1,Y.PC.RT.POS>
***********************************************************************
        END
...
****************************************Modification - 12/10/2020******************************
        IF (Y.TF.EXCHG.RTE.OLD NE "" AND Y.TF.EXCHG.RTE.OLD NE '0') THEN
            Y.EX.AMT.RATED.OLD = Y.OLD.EX.AMT * Y.TF.EXCHG.RTE.OLD
            Y.FOB.AMT.RATED.OLD = Y.OLD.FOB.AMT * Y.TF.EXCHG.RTE.OLD
        END ELSE
            Y.EX.AMT.RATED.OLD = Y.OLD.EX.AMT * Y.TF.EXCHG.RTE
            Y.FOB.AMT.RATED.OLD = Y.OLD.FOB.AMT * Y.TF.EXCHG.RTE
        END
        Y.EX.AMT.RATED = Y.NEW.EX.AMT * Y.TF.EXCHG.RTE
        Y.FOB.AMT.RATED = Y.NEW.FOB.AMT * Y.TF.EXCHG.RTE
    
        Y.TOT.EX.AMT =  R.JOB.REC<BTB.JOB.TOT.EX.LC.AMT>
        Y.TOT.FOB.AMT = R.JOB.REC<BTB.JOB.TOT.NET.FOB.VALUE>
    
        R.JOB.REC<BTB.JOB.TOT.EX.LC.AMT> = Y.TOT.EX.AMT + (Y.EX.AMT.RATED - Y.EX.AMT.RATED.OLD)
        R.JOB.REC<BTB.JOB.TOT.NET.FOB.VALUE> = Y.TOT.FOB.AMT + (Y.FOB.AMT.RATED - Y.FOB.AMT.RATED.OLD)
*****************************************************
...
****************
    ...
    Y.EXCESS.REP.AMT.POS = FLD.POS<1,8>
    Y.NET.FOBVL.POS = FLD.POS<1,9>
    Y.BTB.RT.POS = FLD.POS<1,10>
    Y.PC.RT.POS =  FLD.POS<1,11>
RETURN
