...
*10/20/2020
*Modifided line 77 to 85 for if we set Buyers Credit.Report as YES,
...
* Assign Customer Credit report reference to LC credit Report No field
    EB.DataAccess.FRead(FN.CUS,Y.BENEFICIARY,R.CUS,F.CUS,Y.CUS.ERR)
    IF R.CUS THEN
