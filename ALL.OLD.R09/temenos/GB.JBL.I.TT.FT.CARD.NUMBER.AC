SUBROUTINE GB.JBL.I.TT.FT.CARD.NUMBER.AC
*-----------------------------------------------------------------------------
* Subroutine Description:
* This routine is used TO VALIDATE CARD HOLDER NAME
* Subroutine Type:
* Attached To    : Version (TELLER,JBL.CARD.LOCAL TELLER,JBL.CARD.INT FUNDS.TRANSFER,JBL.CARD.LOCAL AND FUNDS.TRANSFER,JBL.CARD.INT)
...
*** <desc> </desc>
    ...
    IF EB.SystemTables.getPgmVersion() EQ ",JBL.CARD.INT" THEN
    ...
    IF EB.SystemTables.getPgmVersion() EQ ",JBL.CARD.LOCAL" THEN
