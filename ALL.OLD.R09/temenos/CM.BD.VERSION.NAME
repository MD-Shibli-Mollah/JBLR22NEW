...
*   Y.VER.NAME=EB.SystemTables.getRNew(ST.ChqIssue.ChequeIssue.ChequeIsLocalRef)
            Y.VER.NAME=EB.SystemTables.getRNew(CQ.ChqIssue.ChequeIssue.ChequeIsLocalRef)
            Y.VER.NAME<1,Y.CHQ.VER.NAME> = Y.VERSION.NAME
            EB.SystemTables.setRNew(CQ.ChqIssue.ChequeIssue.ChequeIsLocalRef,Y.VER.NAME)
