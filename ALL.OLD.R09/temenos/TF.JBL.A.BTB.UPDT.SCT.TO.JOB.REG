...
SUBROUTINE TF.JBL.A.BTB.UPDT.SCT.TO.JOB.REG
*-----------------------------------------------------------------------------
*Subroutine Description: Contact opening record data write in BD.BTB.JOB.REGISTER
...
PROCESS:
    ...
    BEGIN CASE
        CASE Y.NEW.EXIST EQ 'NEW'
            ...
            REC.JOB.REG<BTB.JOB.JOB.EXPIRY.DATE> = Y.SC.EX.DATE
            Y.COUNT = "1"
