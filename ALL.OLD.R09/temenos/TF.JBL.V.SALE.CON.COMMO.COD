SUBROUTINE TF.JBL.V.SALE.CON.COMMO.COD
*-----------------------------------------------------------------------------
*Subroutine Description: Write Commudity Description in SCT from COMMUDITY.
*Attached To    : FUNDS.TRANSFER Version (BD.SCT.CAPTURE,CONT.RECORD)
