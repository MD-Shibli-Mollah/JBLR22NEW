...
* <Rating>-11</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE GB.JBL.A.DD.ISSUE.RTN
...
*-----------------------------------------------------------------------------
    ...
    Y.LOCAL.FIELDS='LT.COMPANY' : @VM : 'LT.PR.CHEQUE.NO': @VM : 'LT.DD.TT.MT':@VM:'LT.SCROLL':@FM: 'LT.COMPANY': @VM : 'LT.PR.CHEQUE.NO': @VM : 'LT.DD.TT.MT':@VM:'LT.SCROLL'
