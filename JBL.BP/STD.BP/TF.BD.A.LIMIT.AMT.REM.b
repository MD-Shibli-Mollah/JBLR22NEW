SUBROUTINE TF.BD.A.LIMIT.AMT.REM
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
*--------
    ...
    IF REC.STD.FILE NE '' THEN
        ...
        NEXT I
        Y.REM.AMT = Y.MAX.PR.LIM - Y.TOT.REMIT.AMT
        Y.LOC.REF<1,Y.LT.STD.REM.AMT.POS> = Y.REM.AMT
        EB.SystemTables.setRNew(EB.JBL50.LOCAL.REF, Y.LOC.REF)
    END
RETURN
