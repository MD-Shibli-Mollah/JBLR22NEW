SUBROUTINE GB.JBL.BA.SDSA.DUP.CHK
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
INIT:
    ...
    LOCAL.FIELDS = ""
    LOCAL.FIELDS = "LT.ORG.ADJ":VM:"LT.ASST.LIAB"
    FLD.POS = ""
...
PROCESS:
    ...
    Y.FT.AL.POS = EB.SystemTables.getRNew(FT.Contract.FundsTransfer.LocalRef)<1,Y.FT.AL.POS>
    BEGIN CASE
        CASE Y.FT.AL.POS EQ 'A'
