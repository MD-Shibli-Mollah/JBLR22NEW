SUBROUTINE GB.JBL.A.SDSA.WRITE.RTN
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
...
* WRITE ON
*------------------------------ DATA WRITE IN TO BD.SDSA.AC.REFNO Template ---------*
                    WRITE R.SDSA.REF.REC ON F.SDSA.REF, Y.DR.AC.REF
*------------------------------------------------------------------------------------*
...
*----------------------------- Data Write in to entries template------------------*
                    WRITE R.SDSA.DET.REC ON F.SDSA.DET, Y.REF.NO
*----------------------------------------------------------------------------------*
                END ELSE
                    ...
                    END
                END
*--------------------------------------Block for CR Data Write in to Template ------------*
...
*------------------------------------------------------------------------------------*
*   WRITE R.SDSA.DET.REC ON F.SDSA.REF, Y.CR.AC.REF
                    WRITE R.SDSA.REF.REC ON F.SDSA.REF, Y.CR.AC.REF
*--------------------------------------------------------------------------------------*
                    ...
                    R.SDSA.DET.REC<BD.SDSA.CO.CODE> = Y.AC.CO.CODE
                    R.SDSA.DET.REC<BD.SDSA.DEPT.CODE> = EB.SystemTables.getRNew(FT.Contract.FundsTransfer.DeptCode)
* WRITE R.SDSA.DET.REC ON F.SDSA.REF, Y.REF.NO
                    WRITE R.SDSA.DET.REC ON F.SDSA.DET, Y.REF.NO
                END ELSE
                    IF R.SDSA.DET.REC THEN
                        Y.SDSA.ORG.CNT = DCOUNT(R.SDSA.DET.REC<BD.SDSA.ORG.TRANS.REF.NO>,@VM) + 1
